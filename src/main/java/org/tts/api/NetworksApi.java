...
public interface NetworksApi {
    ...
    default ResponseEntity<List<NetworkInventoryItem>> addAnnotationToNetwork(@ApiParam(value = "The fields of the AnnotationItem are used to create annotations in a network as follows:"
    		+ " "
    		+ "Must provide"
...
,@NotNull @ApiParam(value = "A base url of a MyDrug Database including the port number", required = true) @Valid @RequestParam(value = "myDrugURL", required = true) String myDrugURL
    ...
    @RequestMapping(value = "/networks/{UUID}",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    default ResponseEntity<List<NetworkInventoryItem>> copyNetwork(@ApiParam(value = "The user which requests the creation" ,required=true) @RequestHeader(value="user", required=true) String user
...
,@ApiParam(value = "The UUID of the network to delete",required=true) @PathVariable("UUID") UUID UUID
    ...
    @RequestMapping(value = "/networks/{UUID}/filter",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<List<NetworkInventoryItem>> filterNetwork(@ApiParam(value = "The filterOptions to be used in the step upon creation."
    		+ " "
...
,@ApiParam(value = "The network UUID for which the networkOptions are to be fetched",required=true) @PathVariable("UUID") UUID UUID
    ...
    @RequestMapping(value = "/networks/{UUID}/context",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<List<NetworkInventoryItem>> postContext(@ApiParam(value = "The genes for which the context should be generated" ,required=true )  @Valid @RequestBody NodeList body
