...
public interface AnalysisApi {
    ...
    default ResponseEntity<List<GeneAnalysisItem>> getGeneAnalysis(@NotNull @ApiParam(value = "The geneSymbol for which the analysis should be fetched", required = true) @Valid @RequestParam(value = "geneSymbol", required = true) String geneSymbol
) {
